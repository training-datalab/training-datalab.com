---
title: Ranking Chileno de Ciencia Política, marzo 2021
date: 2021-03-01
...
<small>Nota: Las afiliaciones se han estandarizado. Datos recogidos el 1 de marzo de 2021. El Índice-C va de cero a 100 y refleja la coherencia de los perfiles de Google en términos de autoría. Los valores más bajos se asocian a mayores incoherencias, por lo que los indicadores del investigador podrían estar sesgados y su posición podría estar sobrestimada. El índice se ha calculado de la siguiente manera:</small><br>

<small>Índice-C = $100 - \left(100 * \frac{\sum \text{Citas}}{\sum \text{Citas con problemas de autoría}}\right)$</small><br><br>

<small>Investigadores por añadir: Carla Alberti (ID 3tcX6pYAAAAJ), Cristóbal Bywaters C. (ID omFHUesAAAAJ), Maite De Cea (ID tHL6bFwAAAAJ), Lucia Miranda Leibe (ID PfjSTeUAAAAJ), Carlos Meléndez (ID JD_X4KYAAAAJ), Nerea C. Palma (ID qNc7eZgAAAAJ), Diego Telias (ID ZjxwRK0AAAAJ), Amy L. Atchison (ID LWLkiYMAAAAJ), Arlette Martínez Ossa (ID kv5dWS4AAAAJ), Pablo Argote (ID 6DqP7GsAAAAJ) y Jaime Baeza Freer (ID xwVLXRQAAAAJ).</small><br><br>
